window.translations = (function () {
  ...
  var services = {
    uz: svc('02 — XIZMATLAR', 'Kompleks muhandislik xizmatlari', 'JIZZAXYO‘LLOYIHA MChJ yo‘l va transport infratuzilmasi bo‘yicha muhandislik-qidiruv va loyihalashdan tortib, nazorat, konsalting va loyiha hujjatlarigacha bo‘lgan xizmatlarni birgalikda taqdim etadi.', [
      { title: 'Yo‘l va transport infratuzilmasini loyihalash', desc: 'Avtomobil yo‘llari, ko‘priklar va tunnellarni loyihalash bo‘yicha muhandislik yechimlari.', bullets: ['Avtomobil yo‘llarini qurish, rekonstruksiya qilish va ta’mirlash', 'Shahar va qishloq yo‘llari', 'Aeroportlar', 'Ko‘priklar', 'Tunnellar', 'Uy-joy kommunal xo‘jaligi obyektlari va muhandislik tarmoqlarini loyihalash', 'Suv xo‘jaligi obyektlari va muhandislik tarmoqlarini loyihalash'] },
      ...
      { title: 'Baholash va rejalashtirish', desc: 'Xavfsizlik, ekologik va transport rejalashtirish bo‘yicha tahlil xizmatlari.', bullets: ['Yo‘l harakati xavfsizligi bo‘yicha loyihalash', 'Ijtimoiy-iqtisodiy va ekologik baholash', 'Iqlim o‘zgarishi ta’sirini baholash'] },
    ...
    uzCyrl: svc('02 — ХИЗМАТЛАР', 'Комплекс муҳандислик хизматлари', 'JIZZAXYO‘LLOYIHA MChJ йўл ва транспорт инфратузилмаси бўйича муҳандислик-қидирув ва лойиҳалашдан тортиб, назорат, консалтинг ва лойиҳа ҳужжатларигача бўлган хизматларни биргаликда тақдим этади.', [
      { title: 'Йўл ва транспорт инфратузилмасини лойиҳалаш', desc: 'Автомобиль йўллари, кўприклар ва туннелларни лойиҳалаш бўйича муҳандислик ечимлари.', bullets: ['Автомобиль йўлларини қуриш, реконструксия қилиш ва таъмирлаш', 'Шаҳар ва қишлоқ йўллари', 'Аэропортлар', 'Кўприклар', 'Туннеллар', 'Уй-жой коммунал хўжалиги объектлари ва муҳандислик тармоқларини лойиҳалаш', 'Сув хўжалиги объектлари ва муҳандислик тармоқларини лойиҳалаш'] },
      { title: 'Муҳандислик-қидирув ва тадқиқот ишлари', desc: 'Лойиҳалашдан олдинги топографик ва геотехник тадқиқот ишлари.', bullets: ['Топографик / муҳандислик-қидирув ишлари', 'Йўл тўшамаларини тадқиқ қилиш ва ҳисоблаш', 'Грунт ва сув қочириш тизимларини ўрганиш', 'Сув ўтказувчи иншоотлар ва геотехник тадқиқотлар'] },
      { title: 'Баҳолаш ва режалаштириш', desc: 'Хавфсизлик, экологик ва транспорт режалаштириш бўйича таҳлил хизматлари.', bullets: ['Йўл ҳаракати хавфсизлиги бўйича лойиҳалаш', 'Ижтимоий-иқтисодий ва экологик баҳолаш', 'Иқлим ўзгариши таъсирини баҳолаш'] },
    ...
    ru: svc('02 — УСЛУГИ', 'Комплексные инженерные услуги', 'JIZZAXYO‘LLOYIHA MChJ предоставляет полный комплекс услуг в сфере дорожной и транспортной инфраструктуры — от инженерных изысканий и проектирования до надзора, консалтинга и разработки проектной документации.', [
      { title: 'Проектирование дорожной и транспортной инфраструктуры', desc: 'Инженерные решения по проектированию автомобильных дорог, мостов и тоннелей.', bullets: ['Строительство, реконструкция и ремонт автомобильных дорог', 'Городские и сельские дороги', 'Аэропорты', 'Мосты', 'Тоннели', 'Проектирование объектов жилищно-коммунального хозяйства и инженерных сетей', 'Проектирование объектов водного хозяйства и инженерных сетей'] },
      { title: 'Инженерные изыскания и исследования', desc: 'Топографические и геотехнические изыскания на предпроектной стадии.', bullets: ['Топографические / инженерно-изыскательские работы', 'Исследование и расчёт дорожной одежды', 'Изучение грунтов и систем водоотвода', 'Водопропускные сооружения и геотехнические исследования'] },
      { title: 'Оценка и планирование', desc: 'Аналитические услуги в области безопасности, экологии и транспортного планирования.', bullets: ['Проектирование безопасности дорожного движения', 'Социально-экономическая и экологическая оценка', 'Оценка воздействия изменения климата'] },
    ...
    en: svc('02 — SERVICES', 'Comprehensive engineering services', 'JIZZAXYO‘LLOYIHA MChJ provides a full range of services for road and transport infrastructure — from engineering surveys and design to supervision, consulting and project documentation.', [
      { title: 'Design of road and transport infrastructure', desc: 'Engineering solutions for the design of roads, bridges and tunnels.', bullets: ['Construction, reconstruction and rehabilitation of roads', 'Urban and rural roads', 'Airports', 'Bridges', 'Tunnels', 'Design of housing and utilities facilities and engineering networks', 'Design of water management facilities and engineering networks'] },
      { title: 'Engineering surveys and investigations', desc: 'Topographic and geotechnical surveys prior to design.', bullets: ['Topographic / engineering survey works', 'Pavement investigation and design calculations', 'Study of soils and drainage systems', 'Water-crossing structures and geotechnical investigations'] },
      { title: 'Assessment and planning', desc: 'Analytical services covering safety, environmental and transport planning.', bullets: ['Road safety design', 'Socio-economic and environmental assessment', 'Climate change impact assessment'] },
